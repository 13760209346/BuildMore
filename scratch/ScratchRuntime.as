...
package scratch {
	...
	import cc.wuyuankeji.interpreter.FunctionVideoMotion;
	...
	public class ScratchRuntime {
		...
		public function ScratchRuntime(app:WYBuilder, interp:Interpreter) {
			this.app = app;
			this.interp = interp;
...
//				if(WYBuilder.app.isIn3D) obj.updateCostume();
			...
			// OR ELSE: yunTu won't receive any serial data from the robot; it will wait until timeout.
			// +++ added by yu
