...
package ui.parts {
	...
	//	protected var socketMenu:IconButton;
		...
		*/
		...
		private var advertisementShow:IconButton;//add by dragon
...
//		private const offlineNoticeFormat:TextFormat = new TextFormat(CSS.font, 12, CSS.white, true,null,null,null,null,"right");
		...
		public function TopBarPart(app:WYBuilder) {
			this.app = app;
			addButtons();
			refresh();
		}
		...
		public static function strings():Array {
			if (WYBuilder.app) {
//				WYBuilder.app.showFileMenu(Menu.dummyButton());
//				WYBuilder.app.showEditMenu(Menu.dummyButton());
				//WYBuilder.app.showSerialMenu(Menu.dummyButton());
//				WYBuilder.app.showExamplesMenu(Menu.dummyButton());
			}
...
//			copyTool.x = 760+(app.stageIsContracted?ApplicationManager.sharedManager().contractedOffsetX:0);
			...
			advertisementShow.x = shrinkTool.right() + 20*space;//add by dragon
			//helpTool.x = shrinkTool.right() + space;
			copyTool.y = cutTool.y = shrinkTool.y = growTool.y =advertisementShow.y = 4;//buttonY - 3;
...
//			offlineNotice.height = 30;
		...
		private function addToolButtons():void {
			function selectTool(b:IconButton):void {
				...
				if (b == advertisementShow) newTool = 'advertisement';//add by dragon				
			...
			addChild(advertisementShow = makeToolButton('advertisementShow', selectTool));//add by dragon
