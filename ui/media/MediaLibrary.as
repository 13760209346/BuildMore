...
public class MediaLibrary extends Sprite {
	...
	public function MediaLibrary(app:WYBuilder, type:String, whenDone:Function) {
		this.app = app;
		this.assetType = type;
...
//		}
	...
	private function convertAndUploadImageOrSprite(fName:String, data:ByteArray):void {
		...
		function decodeError():void {
			DialogBox.notify('Error decoding image', 'Sorry, Scratch was unable to load the image '+fName+'.', WYBuilder.app.stage);
		}
		var costumeOrSprite:*;
		var fExt:String = '';
