...
package blocks {
	import cc.wuyuankeji.mbot.uiwidgets.lightSetter.LightSensor;
...
public class BlockIO {
	...
	private static function arrayToBlock(cmd:Array, undefinedBlockType:String, forStage:Boolean = false):Block {
		...
		if (cmd[0] == 'getUserName') WYBuilder.app.usesUserNameBlock = true;
	...
	public static function specForCmd(cmd:Array, undefinedBlockType:String):Array {
		...
		var extensionSpec:Array = WYBuilder.app.extensionManager.specForCmd(op);
	...
	private static function specialCmd(cmd:Array, forStage:Boolean):Block {
		...
		case 'changeVariable':
			...
			return b;
		case 'EventHatMorph':
			if (cmd[1] == 'WYBuilder-StartClicked') {
