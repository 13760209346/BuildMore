...
//		if((WYBuilder.app.isIn3D || Capabilities.cpuArchitecture != 'x86') && !force) return [];

		var scale:Number = targetObj.isStage ? 1 : WYBuilder.app.stagePane.scaleX;
		...
		if (filterDict["pixelate"] != 0) {
			...
			if (targetObj == WYBuilder.app.stagePane) n *= WYBuilder.app.stagePane.scaleX;
