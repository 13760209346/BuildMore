package util.version
{
	...
	public class VerResource extends EventDispatcher
	{
		...
		public function load():void{
			...
			clearFolder(ApplicationManager.sharedManager().documents.nativePath+"/yunTu/"+path+"/"+name);
		...
		private function onFileComplete(evt:Event):void{
			...
			var documentPath:String = ApplicationManager.sharedManager().documents.nativePath+"/yunTu/"+path+"/";
