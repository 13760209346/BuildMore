package util.version
{
	...
	public class VersionManager 
	{
		...
		{
			localVersionFile = File.applicationStorageDirectory.resolvePath("yunTu");
		...
		public function start():void{
			...
			var req:URLRequest = new URLRequest("http://download.wuyuankeji.cc/mblock/resources/resource_version.xml?time="+new Date().time);
			_reqLoader.load(req);
		...
		private function onReqError(evt:Event):void{
			...
			if(_isFirst){
				WYBuilder.app.extensionManager.copyLocalFiles();
			...
			WYBuilder.app.extensionManager.importExtension();
		}
