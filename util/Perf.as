...
public class Perf {
	...
	public static function lap(msg:String = ""):void {
		...
		WYBuilder.app.log('  ' + msg + ': ' + lapMSecs + ' msecs');
		lapTotal += lapMSecs;
		lapStart = getTimer();
	}
	...
	public static function end():void {
		...
		WYBuilder.app.log('Total: ' + totalMSecs + ' msecs; unaccounted for: ' + unaccountedFor + ' msecs (' + int((100 * unaccountedFor) / totalMSecs) + '%)');
