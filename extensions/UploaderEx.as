package extensions
{
	...
	public class UploaderEx
	{
		...
		public function upload(filePath:String):void
		{
			...
			_dialog.showOnStage(WYBuilder.app.stage);
			updateDialog();
			...
			WYBuilder.app.scriptsPart.appendMessage(getArduino().nativePath + " " + argList.join(" "));
		...
		private function __onData(event:ProgressEvent):void
		{
			...
			WYBuilder.app.scriptsPart.appendRawMessage(info);
		}
